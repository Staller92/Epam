...
public class ManagePersonServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher_for_managerAdd = request.getRequestDispatcher("/jsp/ManagePersonAdd.jsp");
        RequestDispatcher dispatcher_for_managerEdit = request.getRequestDispatcher("/jsp/ManagePersonEdit.jsp");
        RequestDispatcher dispatcher_for_list = request.getRequestDispatcher("/jsp/List.jsp");
        ...
        // Если же действие указано, то...
            ...
            switch (action) {
                ...
                case "add":
                    ...
                    dispatcher_for_managerAdd.forward(request, response);
                    break;
